...
export default function SettingsPage() {
  ...
  const usersQuery = useMemoFirebase(() => firestore ? collection(firestore, 'users') : null, [firestore], 'users');
  ...
  const form = useForm<UserFormValues | EditUserFormValues>({
    resolver: zodResolver(editingUser ? editUserFormSchema : userFormSchema),
    defaultValues: {
      name: '',
      surname: '',
      email: '',
