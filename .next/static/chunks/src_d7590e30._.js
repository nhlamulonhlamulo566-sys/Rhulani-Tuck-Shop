...
"[project]/src/firebase/provider.utils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var _s = __turbopack_context__.k.signature();
;
function useMemoFirebase(factory) {
    let deps = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], key = arguments.length > 2 ? arguments[2] : void 0;
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useMemoFirebase.useMemo": ()=>{
            const target = factory();
            if (!target || typeof target !== "object") {
                return null;
            }
            const memoKey = key !== null && key !== void 0 ? key : "default";
            if (!target.__memo) {
...
_s(useMemoFirebase, "nwk+m61qLgjDVUp4IGV/072DDN4=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/firebase/provider.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.utils.ts [app-client] (ecmascript)");
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseProvider.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, {
                ...
                "FirebaseProvider.useEffect.unsubscribe": (error)=>setUserAuthState({
                        user: null,
                        isUserLoading: false,
                        userError: error
                    })
...
const useFirebase = ()=>{
    ...
    if (!context.areServicesAvailable || !context.firebaseApp || !context.firestore || !context.auth) throw new Error('Firebase core services not available.');
    return context;
};
...
_s5(useUserAuth, "huZTQEv0vojfA8ahUwgbOjgU01Y=", false, function() {
    return [
        useFirebase
    ];
});
...
"[project]/src/firebase/firestore/firestore-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getStore(key, subscribeFn) {
...
"[project]/src/firebase/firestore/firestore-dev-guards.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function assertMemoized(target) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    if (!target || !target.__memo) {
        throw new Error('❌ Firestore query/reference MUST be memoized using useMemoFirebase.\n' + 'This prevents infinite re-subscriptions and render loops.');
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$firestore$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/firestore/firestore-store.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$firestore$2d$dev$2d$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/firestore/firestore-dev-guards.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
...
function useCollection(target) {
    ...
    const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCollection.useMemo[store]": ()=>{
            if (!target) {
                return EMPTY_STORE;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$firestore$2d$dev$2d$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertMemoized"])(target);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$firestore$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStore"])(target.__key, {
                "useCollection.useMemo[store]": (onNext, onError)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(target, {
                        "useCollection.useMemo[store]": (snap)=>onNext(snap.docs.map({
                                "useCollection.useMemo[store]": (d)=>({
                                        ...d.data(),
                                        id: d.id
                                    })
                            }["useCollection.useMemo[store]"]))
                    }["useCollection.useMemo[store]"], onError)
            }["useCollection.useMemo[store]"]);
        }
    }["useCollection.useMemo[store]"], [
        target
    ]);
    const snap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(store.subscribe, store.getSnapshot, store.getSnapshot);
    return {
        data: snap.data,
...
_s(useCollection, "O1+3cEO0xfkO/vko4kZktfPMbrQ=", false, function() {
    return [
...
function useDoc(target) {
    _s();
    const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDoc.useMemo[store]": ()=>{
            if (!target) return EMPTY_STORE;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$firestore$2d$dev$2d$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertMemoized"])(target);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$firestore$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStore"])(target.__key, {
                "useDoc.useMemo[store]": (onNext, onError)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(target, {
                        "useDoc.useMemo[store]": (snap)=>onNext(snap.exists() ? {
                                ...snap.data(),
                                id: snap.id
                            } : null)
                    }["useDoc.useMemo[store]"], onError)
            }["useDoc.useMemo[store]"]);
        }
    }["useDoc.useMemo[store]"], [
        target
...
_s(useDoc, "O1+3cEO0xfkO/vko4kZktfPMbrQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$firestore$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/firebase/provider.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.utils.ts [app-client] (ecmascript)");
...
function useUser() {
    _s();
    const firestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useFirestore"])();
    const { user, isUserLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useUserAuth"])();
    const userProfileRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "useUser.useMemoFirebase[userProfileRef]": ()=>user ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', user.uid) : null
    }["useUser.useMemoFirebase[userProfileRef]"], [
        user,
        firestore
    ], 'userProfileRef');
    const { data: userProfile, isLoading: profileLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$doc$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"])(userProfileRef);
...
_s(useUser, "yKJBBPhpysIrNBZCxjOvmVWFHA8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useFirestore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useUserAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"],
...
function FirebaseClientProvider(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["FirebaseProvider"], {
...
//# sourceMappingURL=src_d7590e30._.js.map